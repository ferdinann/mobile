...
class Quizchek extends ChangeNotifier {
  List<QuizModel> _quizzes = [
    QuizModel(
      question: "Soal 1: Apa itu Flutter terbaru?",
      rightAnswer:
          "Flutter adalah kerangka kerja UI yang digunakan untuk membangun aplikasi seluler, desktop, dan web hhhh.",
      wrongAnswers: [
